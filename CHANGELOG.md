...
## Unreleased
- Added a dedicated ZENDO menu with optional Zendo Stones, selectable Pyramid or boxed-piece footprint sets, manipulable medium pyramid/wedge/block footprints derived from the existing medium geometry, and a private source-linked community rule helper that stays off the remote Board Display. Refined Pyramid Love toy icon optical sizing, moved Pyramid Die pips to the triangle bases in both play and selector art, and added glass-like glare to Zendo stones.
