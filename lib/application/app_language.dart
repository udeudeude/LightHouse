...
const _es = <String, String>{
  ...
  'Press/release to roll; two-finger drag moves; latch tiles cycle die counts': 'Pulsa y suelta para lanzar; arrastra con dos dedos para mover; las fichas del cierre cambian la cantidad de dados',
  'Tap or hold/release to roll; two-finger drag moves; latch tiles cycle die counts': 'Toca o mantén y suelta para lanzar; arrastra con dos dedos para mover; las fichas del cierre cambian la cantidad de dados',
  'Tap or drag from tray; drag stones; double-click to remove': 'Toca o arrastra desde la bandeja; arrastra las piedras; doble clic para quitar',
  'Tap or drag from tray; drag stones; double-tap to remove': 'Toca o arrastra desde la bandeja; arrastra las piedras; doble toque para quitar',
  ...
  'Free Rotation': 'Rotación libre',
  'Snap Now': 'Ajustar ahora',
  'Game Boards': 'Tableros de juego',
  'Grids': 'Cuadrículas',
  'Martian Chess': 'Ajedrez marciano',
  'Snap pieces to board': 'Ajustar piezas al tablero',
  'None': 'Ninguno',
  'Checker Shading': 'Sombreado ajedrezado',
  'Size': 'Tamaño',
  'Safety Points': 'Puntas seguras',
  'Brightness': 'Brillo',
  ...
  'Swap Roles': 'Intercambiar funciones',
  'Disconnect': 'Desconectar',
  'Turn Off All Ripples': 'Apagar todas las ondas',
  'Table Display Shape Interaction':
      'Interacción con formas en la pantalla de mesa',
  ...
  'Drag through the footprint edge':
      'Arrastra atravesando el borde de la huella',
  'Full / wall light': 'Luz completa / pared',
  'Draw a loop around an upright footprint':
      'Dibuja un bucle alrededor de una huella vertical',
  'Move': 'Mover',
  'Two-finger scroll over a footprint':
      'Desplaza con dos dedos sobre una huella',
  'Rotate': 'Rotar',
  'Shift + two-finger scroll': 'Mayús + desplazamiento con dos dedos',
  'Move + rotate': 'Mover + rotar',
  'Two-finger drag and twist': 'Arrastra y gira con dos dedos',
  'Rotation snap': 'Ajuste de rotación',
  'Edit > Rotation Snap; Snap Now aligns every shape immediately': 'Editar > Ajuste de rotación; Ajustar ahora alinea todas las formas inmediatamente',
  'Board snap': 'Ajuste al tablero',
  'Boards > Snap pieces to board': 'Tableros > Ajustar piezas al tablero',
  'Dice bubble': 'Burbuja de dados',
  'Zendo stones': 'Piedras Zendo',
  'Remote ripple': 'Onda remota',
  'On a Controller, hold a shape to start its ripple; hold again to stop it': 'En un Controlador, mantén una forma para iniciar su onda; mantén de nuevo para detenerla',
  ...
  'Ruler': 'Regla',
  'Large pyramid': 'Pirámide grande',
  'Cancel': 'Cancelar',
  'Use calibration': 'Usar calibración',
  ...
  'Lightning die': 'Dado relámpago',
  'Pyramid die': 'Dado pirámide',
  'Treehouse die': 'Dado Treehouse',
  'Color die': 'Dado de color',
...
const _ja = <String, String>{
  ...
  'Game Boards': 'ゲームボード',
  'Grids': 'グリッド',
  'Martian Chess': 'マーシャン・チェス',
  'Snap pieces to board': '駒をボードにスナップ',
  'None': 'なし',
  'Checker Shading': '市松模様',
  'Size': 'サイズ',
  'Safety Points': '安全な先端',
  'Brightness': '明るさ',
  ...
  'Zendo Stones': 'Zendoストーン',
  'Classic': 'クラシック',
  'Classic + Zendo 2.0': 'c��ラシック + Zendo 2.0',
  'Zendo Rule': 'Zendoルール',
  'Different Zendo Rule': '別のZendoルール',
  ...
  'Add Another Controller': 'c��ントローラーを追加',
  'Show Pairing QR': 'ペアリングQRを表示',
  'Swap Roles': '役割を交換',
  'Disconnect': '切断',
  'Turn Off All Ripples': 'すべての波紋をオフ',
  'Table Display Shape Interaction': 'c��ーブル表示で形を操作',
  ...
  'Move': '移動',
  'Two-finger scroll over a footprint': 'フットプリント上で2本指スクロール',
  'Rotate': '回転',
  'Shift + two-finger scroll': 'Shift + 2本指スクロール',
  'Move + rotate': '移動 + 回転',
  ...
  'Ruler': '定規',
  'Large pyramid': 'ラージ・ピラミッド',
  'Cancel': 'c��ャンセル',
  'Use calibration': 'この調整を使う',
  'A Large upright pyramid should fit this square:':
      '立てたラージ・ピラミッドがこの四角にぴったり収まるはずです：',
  'Cross-check: this bar should measure exactly 25 mm:': '確認：このバーはちょうど25 mmです：',
  'Recalibrate': '再調整',
  'Looks right': 'これでOK',
  'Dice': 'ダイス',
  'selected': '選択',
  'Regular D6': '通常D6',
  'Lightning die': 'ライトニング・ダイス',
  'Pyramid die': 'ピラミッド・ダイス',
  'Treehouse die': 'ツリーハウス・ダイス',
  'Color die': 'カラー・ダイス',
  'Fudge / Fate die': 'Fudge / Fateダイス',
  'Remove one': '1個減らす',
  'Add one': '1個増やす',
  'Done': '完了',
};
